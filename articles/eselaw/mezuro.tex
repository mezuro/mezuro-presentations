...
Em seu início como Kalibro, o \textit{software} dispunha de uma interface gráfica nativa em Java, mas logo tomou o rumo de ser um serviço web e assim esta interface deixou de ser mantida. Porém, para suprir a necessidade de prover para humanos utilizando o Kalibro boas formas de visualização, em \cite{meirelles2013monitoramento} foi concebido o projeto então denominado Mezuro (que atualmente foi renomeado para Prezento e o nome Mezuro se refere ao projeto todo).

Como já foi mencionado, o primeiro protótipo do Mezuro surgiu em 2010, mas a equipe ainda inexperiente com o arcabouço \textit{Ruby on Rails} teve grande dificuldade em evoluir com o desenvolvimento e esta versão acabou sendo reestruturada como um \textit{plugin} para outro software já existente o Noosfero.
