...
\author{Rafael R. Manzo\inst{1}, Diego de A. M. Camarinha\inst{1},\\
        Alessandro Palmeira\inst{1}, Heitor R. Ribeiro\inst{1},\\
        Daniel P. Alves\inst{1}, Renan Fichberg\inst{1}, Paulo Meirelles\inst{2}
...
\institute{Instituto de Matemática e Estatística -- Universidade de São Paulo (USP)\\
  ...
  \email{\{manzo, damc90\}@ime.usp.br, \{alessandro.palmeira,renan.fichberg,heitor.ribeiro,daniel.paulino\}@usp.br}
  \and
  Faculdade de Engenharia -- UnB Gama (FGA)\\
  Gama -- DF -- Brasil
  \email{paulo@softwarelivre.org}}
