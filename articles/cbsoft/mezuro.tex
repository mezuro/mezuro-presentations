...
%TODO Arrumar as flags de figure pra as imagens não ficarem todas espalhadas pelo artigo.
    \begin{figure}[ht]
      \centering
    ...
    Após preencher todos os campos e salvar o repositório, seu primeiro processamento será automaticamente ativado e o usuário será redirecionado para a página que exibe os resultados. Nela, o usuário poderá conferir dados do processamento (tempo gasto para o término de cada uma de suas fases), navegar na árvore de módulos (pacotes e classes, basicamente) gerada, para que possa visualizar os resultados das métricas e a nota de cada um deles especificamente. Além disso, ao clicar no nome de uma métrica calculada, um gráfico com a evolução dos valores da métrica ao longo dos processamentos será exibido.
