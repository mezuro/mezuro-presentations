...
%TODO Arrumar as flags de figure pra as imagens não ficarem todas espalhadas pelo artigo.    
    ...
    \begin{itemize}
      \item \textbf{Type:} Tipo do repositório (ou tarball) onde o código está hospedado.
      \item \textbf{Address:} Endereço do repositório remoto.
      ...
      \item \textbf{Configuration:} Configuração de métricas que você deseja utilizar para medir o código. Tal configuração pode ser escolhida dentre todas as configurações criadas pelos usuários.
    \end{itemize}

%TODO Completar a parte do processamento
%    \begin{figure}[ht]
%      \centering
%      \frame{\includegraphics[width=\textwidth]{images/new-repository-results.png}}
%      \caption{Tela de visualização dos resultados da avaliação do repositório.}
%      \label{fig:choose-metric}
%    \end{figure}
